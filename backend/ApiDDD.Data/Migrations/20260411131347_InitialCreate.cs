    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Alimentação", 1 });

            migrationBuilder.InsertData(
                table: "Pessoas",
                columns: new[] { "Id", "Idade", "Nome" },
                values: new object[] { 1L, 30, "João Silva" });

            migrationBuilder.InsertData(
                table: "Pessoas",
                columns: new[] { "Id", "Idade", "Nome" },
                values: new object[] { 2L, 25, "Maria Souza" });

            migrationBuilder.InsertData(
                table: "Pessoas",
                columns: new[] { "Id", "Idade", "Nome" },
                values: new object[] { 3L, 17, "Pedro Alves" });

            migrationBuilder.InsertData(
                table: "Transacoes",
                columns: new[] { "Id", "CategoriaId", "Descricao", "PessoaId", "Tipo", "Valor" },
                values: new object[] { 1L, 1L, "Supermercado", 1L, 1, 350.00m });
